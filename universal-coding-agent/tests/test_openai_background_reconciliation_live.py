...
def test_restart_reconciliation_live_scenario_is_explicit_and_redacted(
    ...
    assert summary["lifecycle_recovery_receipt_reloaded"] is True
    assert summary["lifecycle_recovery_private_owner_absent"] is True
    assert summary["lifecycle_recovery_bounded_reads"] is True
    ...
    assert summary["lifecycle_recovery_field_validation_indexes_backed"] is True
