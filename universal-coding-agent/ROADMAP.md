...
have not started. The canonical [local API task](plans/P3_5D2C1_LOCAL_CONTINUATION_API_TASK_2026-09-08.md)
and [command/status contract](plans/P3_5D2C1_HTTP_COMMAND_AND_STATUS_CONTRACT.md)
